...
public class OldCalendarFragment extends Fragment {
    ...
    public void onDestroy() {
        Log.e("DEBUG", "OnDestroy of OldCalendarFragment");
        super.onDestroy();
    }

    @Override
    public void onPause() {
        Log.e("DEBUG", "OnPause of OldCalendarFragment");
        super.onPause();
...
//                                   .getConnectionStatusCode());
                    ...
                    startActivityForResult(
                            ...
                            OldCalendarFragment.REQUEST_AUTHORIZATION);
                } else {
